...
def treatment_sum(our_tuple):
    """
    Функция складывает два элемента из входящего кортежа,
    если их нельзя сложить, или элементов меньше двух, или больше двух,
    то функция генерирует исключения.
    :param our_tuple: Заданный кортеж.
    :return: Результат сложения чисел из кортежа или сообщение об исключении.
    """
    if len(our_tuple) < 3:
        try:
