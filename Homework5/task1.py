...
def letter_stat(our_str):
    """
    функция считает количество вхождений каждой буквы в строку
    :param our_str: заданная строка
    :return: выводит количество вхождений каждой буквы в заданную строку
    
    """
    # Здесь нужно написать код
    letters_dict = {}
    for bukva in our_str:
        if letters_dict.get(bukva) is None:
            letters_dict.update({bukva: 1})
        else:
            amount = letters_dict.get(bukva)
            letters_dict.update({bukva: amount + 1})
    return letters_dict
