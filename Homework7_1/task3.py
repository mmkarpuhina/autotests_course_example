...
class PublicTransport:
    def __init__(self, brand, engine_power, year, color, max_speed):
        """
        Метод инициализации класса PublicTransport
    ...
    def info(self):
        """
        Функция выводит на печать информацию о:
        марке, цвете, годе выпуска и мощности двигателя.
        """
...
class Bus(PublicTransport):
    ...
    def __init__(self, brand, engine_power, year, color, max_speed, passengers, park, fare):
        """
        Метод инициализации класса Bus, наследованного от класса PublicTransport
        с добавлением новых атрибутов
    ...
    def park(self):
        """
        Функция обходит запрет на работу с приватным атрибутом.
        :return: Возвращаем не приватную перeменную.
        """
        return self.__park
    ...
    def park(self, park):
        """
        Функция проверяет номер парка, что он в диапазоне от 1000 до 9999
...
class Tram(PublicTransport):
    ...
    def __init__(self, brand, engine_power, year, color, max_speed, route, path, fare):
        """
        Метод инициализации класса Tram, наследованного от класса PublicTransport
        с добавлением новых атрибутов
        :param route: Mаршрут трамвая
    ...
    def how_long(self):
        """
        Функция вычисляет время прохождения маршрута по формуле max_speed/(4*path)
