...
class PersonInfo:
    def __init__(self, name, age, *department):
        self.name = name  # Имя Фамилия сотрудника
        self.age = age  # Возраст сотрудника
        self.department = department  # Подразделения от головного до того, где работает сотрудник

    def short_name(self):
        """
к       Функция возвращает строку Фамилия Имя.
